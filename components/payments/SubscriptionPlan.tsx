...
const SubscriptionPlan = () => {
  ...
  // Defaulting to English as per requirement for public page or no language context availability
                  ...
                  {data.price.permember ? (
                    <div className="flex flex-col gap-2">
                      ...
                      <a
                        ...
                        className={`block text-center w-full transform rounded-2xl border-2 border-black py-3 font-semibold transition-transform hover:scale-105 ${colorScheme.button}`}
                      >
                        Get Started
                      </a>
                    </div>
