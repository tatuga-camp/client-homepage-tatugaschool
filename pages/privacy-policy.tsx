      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-800">
        <header className="mb-8 sm:mb-10">
          <h1 className="text-3xl sm:text-4xl font-semibold text-gray-900">
            Privacy Policy for Tatuga School - web application for school
            management
          </h1>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-700 leading-relaxed">
              ...
              <li>
                ...
                in this Agreement) refers to ห้างหุ้นส่วนจำกัด ทาทูก้าแคมป์ /
                Tatuga Camp Limited Partnership, 879 หมู่ที่ 3 ตำบลโพธิ์กลาง
                อำเภอเมืองนครราชสีมา จังหวัดนครราชสีมา.
              </li>
              <li>
                <strong>Cookies</strong> are small files that are placed on Your
                computer, mobile device or any other device by a website,
                containing the details of Your Browse history on that website
                among its many uses.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Tatuga School - web
                application for school management, accessible from
                tatugaschool.com
              </li>
              <li>
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-700 leading-relaxed mb-2">
              <li>Google</li>
              <li>Facebook</li>
              <li>Instagram</li>
              <li>Twitter</li>
